...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-sand-50">
      {/* Dark-ocean hero band: header + hero sit on the deep coastal gradient. */}
      <div className="ocean-hero">
        <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
          ...
          <nav className="flex items-center gap-2">
            <Link href="/login" className="rounded-xl px-4 py-2 text-sm font-medium text-navy-100 hover:bg-white/10">
              Sign in
            </Link>
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <section className="py-16 sm:py-24">
            <div className="max-w-3xl">
              <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-xs font-medium text-brand-200 ring-1 ring-inset ring-white/20">
      ...
      <main className="mx-auto max-w-6xl px-6">
        {/* Feature cards */}
        <section className="grid gap-5 py-16 sm:grid-cols-2 lg:grid-cols-4">
          <Feature
